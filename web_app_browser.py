...
def health():
    return jsonify({
        ...
        'failure_table': 'v2-key-value-reason-safe-dom',
        'closing_diagnosis': 'sequence-with-inutilization-reconciliation-safe-dom',
        'inutilization_reconciliation': 'homologated-cstat-102',
        'security_headers': 'hardening-v1-csp-phase3',
        'browser_security': 'xss-display-escape-limits-dom-navigation-safe-dom-v4',
